                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="row   border-info alert ">
                                        <div class="col-12 col-lg-3 my-2">
                                           ...
                                           <p class="btn btn-sm mt-2" title="<?php echo $row['company_address'] . " " . $row['country_name']  ?>"><i class="fa-solid fa-location-dot fa-fade mx-2" style="color: #23b110;"></i> <?php echo $row['country_name'] ?></p>
                                             <div class="d-block">
                                                             <?php
                                            if ($plan == "prime") {
                                        ...
                                        <div class="col-12 col-lg-5 my-2 text-capitalize" >
                                            <div class="product_content" style="height: 300px;overflow-Y:scroll">
                                                ...
                                                <p   ><small class="glp modal-btn d-block text-center" style="width:200px">  <?php echo $row['price'] ?> <?php echo $row['unit'] ?></small></p>
                                        ...
                                        <div class="col-12 col-lg-4 my-2  ">
                                            ...
                                            <a href="single-product.php?pro_id=<?php echo $row['pro_id'] ?>" class="btn btn-danger">👉🏻 Product Details</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                           <a target="_blank" href="<?php echo $row['website'] ?>"> <img src="logo/logo.png" height="60px" width="200px" alt="Logo"  ></a>
                                                               ...
                                                               <div class="container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        ...
                                                                        <input type="text" name="enquiry_for" placeholder="Enquiry Product Name" value="<?php echo $product_name ?>" class="form-control my-2">
...
include "config.php";
    if (isset($_POST['submit'])) {
        ...
        $ins = "INSERT INTO `enquiry`(`buyer_name`,`buyer_email`,`buyer_phone`,`enquiry_for`) values ('$buyer_name','$buyer_email','$buyer_phone','$product_name')";
