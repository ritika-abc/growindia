            ...
            <div class="row">
                ...
                ?>
                    <div class="col-6 col-md-4 col-lg-2 my-2">
                        <a href="micro-category.php?micro_id=<?php echo $row1['micro_id'] ?>&state_name=<?php echo $state_name?>" class="text-decoration-none h-100 text-dark border   d-block p-2 rounded">
