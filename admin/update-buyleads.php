    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12 col-md-4 my-3 text-capitalize">
                ...
                <input type="text" name="buyer_name" value="<?php echo $buyer_name ?>" class="form-control mt-1">
            </div>
            <!--<div class="col-12 col-md-4 my-3 text-capitalize">-->
            ...
            <div class="col-12 col-md-4 my-3 text-capitalize">
                ...
                <input type="number" name="number" value="<?php echo $number ?>" class="form-control mt-1">
            </div>
            <div class="col-12 col-md-4 my-3 text-capitalize">
            ...
            <div class="col-12 col-md-4 my-3 text-capitalize">
                ...
                <input type="email" name="buyer_email" value="<?php echo $buyer_email ?>" class="form-control mt-1">
            </div>
            <div class="col-12 col-md-4 my-3 text-capitalize">
            ...
            <div class="col-12 col-md-4 my-3 text-capitalize">
                <label for="">Mode Of Payment</label>
                 <select class="form-control" name="payment_mode">
                         ...
                         <option value="F.O.B" <?php if ($payment_mode == 'F.O.B') echo 'selected'; ?>>F.O.B</option>
                         <option value="C.I.F" <?php if ($payment_mode == 'C.I.F') echo 'selected'; ?>>C.I.F</option>
                     </select>
            </div>
            <div class="col-12 col-md-4 my-3 text-capitalize">
            ...
            <div class="col-12 col-md-12 my-3 text-capitalize">
                ...
                <textarea name="queiry_for" class="form-control" rows="5"><?php echo $queiry_for ?></textarea>
            </div>
