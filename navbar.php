   <section class="d-none d-sm-none d-md-none d-lg-block">
                <div class="top_nav">
                        <div class="container">
                                <div class="row">
                                        <div class="col-12">
                                                <ul class="nav py-2">
                                                        <li class="nav-item"><a href="supplier-login.php" class="btn btn-dark mt-1" style="background:#e77702;"> Login Supplier </a></li>
                                                       
                                                        <li class="nav-item   w-50"><a href="advertise.php" class="nav-link text-white">
                                                                        <marquee behavior="" direction="">
                                                                            <p class="p-0 m-0"><span>Advertise Wih Us</span> || Prime || Prime Pro || Ultra || Ultra Pro</p>
                                                                        </marquee>
                                                                </a></li>
                ...
                <!--         </ul>-->
                <!--</div>-->
                 <div class="header_top bg-white py-3 shadow-sm ">
                        <div class="container">
                                <div class="row align-items-center">
                                        <div class="col-3">
                                                <a href="/" class="nav-link"><img src="logo/logo.png" height="75px" width="250px" alt="https://growindiaexport.com/"></a>
                                        </div>
                                        <div class="col-6">
                                                <form action=" " class="mobile-search hidedesktop  ajex_search    " id="liveSearchForm">
                                        ...
                                        <div class="col-3">
                                        <a href="" class="nav-link"> <a href="post-requirement.php" class="btn btn-primary px-3 mx-2 rounded-pill">Post Your Buy Requirement</a>
                                        </div>
                                </div>
                        </div>
                </div>
                ...
                <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                         ...
                                         <li class="nav-item">
                                                <a class="nav-link  "  href="https://growindiaexport.com/advertise.php">Advertise With Us</a>
                                        </li> 
                                        <!-- <li class="nav-item">
