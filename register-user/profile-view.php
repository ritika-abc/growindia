...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["image"]["error"] == UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES["image"]['tmp_name'], $image_path)) {
            // If image uploaded successfully, update image field in database
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="container-fluid task_list_view">
                                        ...
                                        <div class="row    ">
                                            ...
                                            <div class="col-lg-6 my-3 ">
                                                <div class="">
                                                    <label for="" class=" text-danger">Enter Product / Service Name*</label>
                                                    <input type="text" class="form-control" name="product_name" value="<?php echo $product_name; ?>" placeholder="Enter Product / Service Name">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
