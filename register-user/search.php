                                ...
                                <div class="col-lg-9 ">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form method="POST" action="get_buylead.php">
                                            ...
                                            <?php  echo ($status == '1') ? '<button type="submit" class="btn btn-secondary text-center" style="width:200px;" name="submit">Client Details   </button>' : '<a href="tel:" class="btn btn-secondary text-center" style="width:200px;" >Client Details  </a>'; ?>
